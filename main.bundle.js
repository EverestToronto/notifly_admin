...
var WebService = (function () {
    ...
    WebService.prototype.newTrainer = function (trainer) {
        return this._http.post('https://us-central1-remindly-dev.cloudfunctions.net/new_trainer', trainer)
            .map(function (res) { return res; });
    };
    WebService.prototype.addTrainerAvailability = function (trainer_key, selected_day, start_time, end_time) {
        return this._http.get('https://us-central1-remindly-dev.cloudfunctions.net/add_availability?trainer_key=' + trainer_key + '&selected_day=' + selected_day + '&start_time=' + start_time + '&end_time=' + end_time)
            .map(function (res) { return res; });
    };
    WebService.prototype.deleteTrainerAvailability = function (trainer_key, slot_day, slot_key) {
        return this._http.get('https://us-central1-remindly-dev.cloudfunctions.net/delete_availability?trainer_key=' + trainer_key + '&slot_day=' + slot_day + '&slot_key=' + slot_key)
            .map(function (res) { return res; });
    };
    return WebService;
}());
...
var environment = {
    production: false,
    firebaseConfig: {
        apiKey: "AIzaSyDr29_SHKF2CE1UKlUEFnWVU9lIH8zJaJE",
        authDomain: "remindly-dev.firebaseapp.com",
        databaseURL: "https://remindly-dev.firebaseio.com",
        projectId: "remindly-dev",
        storageBucket: "",
        messagingSenderId: "526996839304"
    }
};
